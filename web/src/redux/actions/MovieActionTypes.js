...
export const MOVIES_BY_NAMES_GET_REQUEST = 'MOVIES_BY_NAMES_GET_REQUEST';
export const MOVIES_BY_NAMES_GET_SUCCESS = 'MOVIES_BY_NAMES_GET_SUCCESS';
export const MOVIES_BY_NAMES_GET_FAILURE = 'MOVIES_BY_NAMES_GET_FAILURE';
